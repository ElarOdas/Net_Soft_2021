...
class SwitchControl:
    ...
    def writeFlowAggregationRule(self, dstAddr, dstPrefix, protocol, action):
        # Assemble the table entry
        table_entry = self.p4info_helper.buildTableEntry(
            table_name="MyIngress.flowBasedAgg",
            match_fields={
        ...
        print "Installed Flow Aggregation rule on switch %s" % self.switch.name
