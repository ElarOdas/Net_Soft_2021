...
control MyIngress(inout headers hdr,
    ...
    counter(256, CounterType.packets_and_bytes) sent_counts;
    counter(256, CounterType.packets_and_bytes) rec_counts;
    apply {
        ...
        bit<9> sent_index = standard_metadata.egress_spec;
        sent_counts.count((bit <32>) sent_index);
        bit<9> rec_index = standard_metadata.ingress_port;
        rec_counts.count((bit <32>) rec_index);
    }
}
